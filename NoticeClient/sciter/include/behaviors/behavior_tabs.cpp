...
struct tabs: public event_handler, behavior_factory
{
    ...
    { 
      ...
      //tabs_el.start_timer(1000, (void*) 12345);

    } 

    /*virtual bool on_timer  (HELEMENT he, UINT_PTR timerId ) 
    {
    ...
    dom::element target_tab(HELEMENT he, HELEMENT h_tabs_container)
    {
      ...
      dom::element el = he;
      json::string panel_name = el.get_attribute("panel");
